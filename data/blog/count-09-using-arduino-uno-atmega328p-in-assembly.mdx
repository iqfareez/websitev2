...
draft: false
summary: Using Arduino with a 7-Segment display to count numbers using Arduino IDE (C/Cpp) is too mainstream. How about we code using Assembly? Let's see how I put up the pieces together
