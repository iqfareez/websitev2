...
mentioned something about DDC. This is the point where I've learnt that we can use DDC to control the monitor (Wow 🤩). I quickly check my monitor in the OSD menu, hoping that my 
monitor support DDC (as I'm dying to try it already!).

Boom! There it is. Already enabled my default. We are in the game, boys!

The **Display Data Channel**, or **DDC**, is a protocol that allows monitor and computer exchange information to each other over an [I²C](https://learn.sparkfun.com/tutorials/i2c/all) busses.
...
As mentioned earlier, DDC is nothing but an I²C busses, or known as Two-Wire interface. It uses two wire to communicate, DATA & CLOCK. Below
is the basic example of I²C *(Image credit [CircitBasics](https://www.circuitbasics.com/basics-of-the-i2c-communication-protocol))* 

![Basic i2c](/static/blog/monitor-ddc/Introduction-to-I2C-Single-Master-Single-Slave.png)

DDC is implemented on common video interface like HDMI, DP, VGA etc. So, look to their pinouts to look where the DDC is implemented. Below is the example of
VGA PORT.

Why VGA? Because my monitor have two inputs, HDMI & VGA. HDMI is already used, empty port is VGA.

![VGA pinout for DDC](https://res.cloudinary.com/iqfareez-cloud/image/upload/v1708994080/website/monitor%20control%20DDC/DDC_VGA_Pinout_djhh79.png)
