...
date: '2024-02-15'
tags: ['AR', 'navigation', 'unity', 'hierarchical localization']
draft: false
...
Then of course, there is 'sesi bantai-membantai' with the examiners (basically it's just QnA session with some spices 🌶️️), but Alhamdulillah I was able to answer it quite OK.
...
window like it asking me to jump off. 😂😂
...
Well, guess what? The project was dormant for about 2+ months (~10-ish weeks) 🤡
