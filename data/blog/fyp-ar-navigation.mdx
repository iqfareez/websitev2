...
When the list of titles for the final year project (FYP) was released for us to select, there were several titles that I was interested in. But, seeing the title
**"Development of turn-by-turn navigation in Kulliyyah of Engineering (KOE) building using natural landmark detection"** caught my eye. Because of my inclination
towards software development, I thought this project would be a good fit for me.
...
Upon further meetings with my supervisor, the requirements were refined as follows:
...
My project is targeted to be used within/inside a building, so GPS is not suitable for this project since the walls and building structure
...
GPS. So, a suitable option to use indoors is vision-based navigation.
...
After that, I looked for a tool/algorithm to train the data. I had the idea to use PyTorch or TensorFlow, like a normal image classification project. But, upon
further research, I found a method called [Hierarchical Localization](https://github.com/cvg/Hierarchical-Localization) to localize the image and predict where the image is. It sounded
...
The project provides sample code and even a Google Colab script to demonstrate Hierarchical Localization. I yoinked the code and ran it on my own image data.
It works and it looks promising. After this point, I was slowly making progress on finishing the report (part 1) and presentation slides.
...
![fy1 slide pp](/static/blog/fyp-ar-navigation/presentation-fyp1-pp.png)
...
proud. Haha, it was truly a delightful moment! (Of course, I'm not the best of all, it's just coincidentally & relatively better than the persons before me)
...
> For some reason that you might be interested in my presentation slides, here is the [link](https://www.slideshare.net/MuhammadFareezIqmal/fyp1-presentation-development-of-interactive-turnbyturn-navigation-in-kulliyyah-of-engineeringpdf).
...
window like it was asking me to jump off. 😂😂
...
First I started to understand the navigation system in Unity, i.e. walking etc. There was a good tutorial [on YouTube]() about developing a basic AR navigation system using Unity. The tutorial
provided me some basic understanding of how the overall navigation system would work. So, the next part is to develop the localization system.
...
I regret not doing anything for the whole semester because I was caught up with other stuff like studying and other commitments*. Here's a screenshot showing I didn't even open it for 3 months haha. And when I finally did, it was just a week before submission, that's usually when the deadline pressure really kicks in. I wish I had more time available for this project.
...
Well, guess what? Despite my best intentions, the project ended up untouched for over two months. That's more than 10 weeks vanished into the void! 🤡

So, what happened next? What was my so-called "pro-gamer move" for the semester? One reason is, I was caught in a whirlwind of busyness, just like in the semester 1.

I think I didn't have much motivation to continue with the project. I no longer enjoyed doing it unlike the first time I received the project. There was a lot to grasp in a relatively short time, unresolved issues that I didn't have anyone to refer to, and so on. Though, I'm not blaming anyone.
...
Of course, there is a very big room for improvement for this project to make it production ready.
