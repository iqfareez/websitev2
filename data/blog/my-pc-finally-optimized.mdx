...
Since I [built my first PC in 2024](i-built-my-first-pc), I have been unable to configure my RAM to run at its advertised speed. I have a single 16 GB Adata XPG Lander DDR5 RAM module that is advertised to run at 6000 MT/s. It has an EXPO profile that I can enable in the BIOS. However, when I activate the profile, my PC randomly crashes or stops responding while I use it. I have to force it to shut down before starting it again.
...
Recently, ASRock (my motherboard manufacturer) released a BIOS update mentioning 'Improved memory compatibility'. This was the first memory-related fix listed in its [BIOS update history](https://www.asrock.com/MB/AMD/A620M-HDVM.2/index.asp#BIOS), so I updated the BIOS and enabled the EXPO profile again.
