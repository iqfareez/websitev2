...
We can create a new flows, but on this article, I will reuse the [flows.json](https://gist.github.com/iqfareez/80a9c3ae246ffcbcf58dc2ea6c4cb115) that we have created from the [previous article](./get-started-on-iot-with-nodered-esp32#conclusion).
