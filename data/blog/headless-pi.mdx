...
draft: false
summary: Finally got one Raspberry to tinker around. I want to make a home server. Here's my way to set up the Pi in headless mode (without monitor, keyboard & mouse).
