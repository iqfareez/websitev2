---
title: How to setup signed commits on Windows
date: '2024-09-22'
tags: ['tutorial', 'git', 'github']
draft: false
summary: Get a cool Verified badge on Github! Besides, it help verify the authenticity of your code changes, making sure they come from you.
...
Install the softwares below into your machine.
...
Launch **Kleopatra** and click on <kbd>New OpenPGPG Key Pair...</kbd>
...
Fill in your **name** and **email address** you have choosen earlier. If you want to customize the key type or the expiry date, click on <kbd>Advanced Settings...</kbd>. Then, click <kbd>OK</kbd>.
...
On **GPG keys** section, click on <kbd>New GPG key</kbd>. It will ask for a title and key. For
...
To fill key **Key** field, you'll need the public key for the key you just created. Back to Kleopatra, double-click
...
A dialog will appear, copy everyhing in the dialog and paste it into the **Key** field.
...
If you haven't setup your gti username and password yet, you can do it now.
...
(Optional) Unset the previously set GPG key if you have setup before this.
...
Replace the key ID with your own key ID. You can find the Key ID from Klepatra or Github.
...
That's it, how easy it is to setup a signed commits. Ask me any question you have. For more information, please consult
the documentation.
